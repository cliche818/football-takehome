class CreatePlayerRushingStats < ActiveRecord::Migration[6.0]
  def change
    create_table :player_rushing_stats do |t|
    ...
    add_index :player_rushing_stats, :total_rushing_yards
    add_index :player_rushing_stats, :longest_rush
    add_index :player_rushing_stats, :total_rushing_touchdowns
